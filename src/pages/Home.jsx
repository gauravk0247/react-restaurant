                ...
                <div className='container'>
                    <div className='row'>
                        <div className='col-sm-6 d-flex d-sm-block flex-column align-items-center'>
                            ...
                            <h1 className='mb-5 text-black fw-bold text-center text-sm-start'>Vaishnavi Restaurant</h1>
                            <MenuBtn />
                        </div>
                    </div>
                </div>
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            ...
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Paneer Tika</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>220 ₹</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Pulav</p>
                                    <p className='fs-3 mx-2 text-success fw-nold'>120 ₹</p>
                                </li>
                                <li className='d-flex justify-content-between'>
                                    <p className='fs-3 mx-2'>Paneer Masala</p>
                        ...
                        <div className='col-lg-6 d-flex flex-column align-items-center mb-5 mb-lg-0'>
                            ...
                            <ul className='px-0'>
                                <li className='d-flex justify-content-between'>
                                    ...
                                    <p className='fs-3 mx-2 text-success fw-nold'>160 ₹</p>
                                </li>
                                <li className='d-flex justify-content-between'>
